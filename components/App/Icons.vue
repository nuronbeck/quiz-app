...
<script>
import AppMaterialIcons from '~/components/App/Icons/MaterialIcons'
import AppFontAwesomeIcons from '~/node_modules/vue-icons-demo-app/src/AppFontAwesomeIcons'
