    ...
    <div :class="containerClass">
      <div class="page-section">
        ...
        <div class="row card-group-row">
          <div
            v-for="item in development_courses" 
            :key="item.id"
            class="col-lg-3 card-group-row__col">
            <course-card
              :account="true"
              :title="item.title"
              :image="item.image"
        ...
        <page-separator>Achievements</page-separator>
        <achievements-carousel-multi />
...
import ResumeCourse from '~/components/App/Course/ResumeCourse'
import AccountPathCard from '~/components/App/AccountPathCard'
import CourseCard from '~/components/App/CourseCard'
import Pager from '~/components/App/Pager'
import AchievementsCarouselMulti from '~/components/App/Student/Dashboard/AchievementsCarouselMulti'
