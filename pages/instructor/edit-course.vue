        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <b-card
              ...
              <div class="card-body">
                <b-form-group
                  :description="$t('Enter a valid video URL.')" 
                  :label="$t('URL')"
            ...
            <b-card>
              ...
              <b-form-group
                :description="$t('Select one or more tags.')" 
                :label="$t('Tags')"
                label-class="form-label"
                class="mb-0">
                <b-form-tags 
...
<script>
  ...
  import EditCourseBasic from '~/components/App/Instructor/EditCourseBasic'
